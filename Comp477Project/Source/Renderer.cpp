...
void Renderer::EnablePrimaryViewport(int width, int height)
{
	glViewport(0, 0, width, height);
}

void Renderer::EnableSecondaryViewport(int width, int height)
{
	int x = width * 0.75f;
	int y = height * 0.75f;
	int viewWidth = width * 0.25f;
	int viewHeight = height * 0.25f;
